...
{
    class InvalidRangeExceptionSample
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                if (number < intExeption.StartRange || number > intExeption.EndRange)
                {
                    throw intExeption;
                }
                else
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                if (someDate.Year < someDateExpection.StartRange.Year || someDate.Year > someDateExpection.EndRange.Year)
                {
